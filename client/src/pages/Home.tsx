...
import { FiShield, FiAlertTriangle, FiMap, FiFileText, FiUser, FiHome } from 'react-icons/fi';
...
export const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      {/* Login Options Section - Show when NOT logged in */}
      {!user && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Get Started</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Choose your role and access the platform
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-2xl mx-auto">
            {/* Student Login Card */}
            <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow overflow-hidden border-t-4 border-blue-600">
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6 text-center">
                  Report safety issues, view accommodation reviews, and make informed decisions.
                </p>
                <div className="flex flex-col gap-3">
                  <Link
                    to="/login"
                    className="inline-block px-6 py-2 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-center transition-colors"
                  >
                    Student Login
                  </Link>
                  <Link
                    to="/register"
                    className="inline-block px-6 py-2 border-2 border-blue-600 text-base font-medium rounded-md text-blue-600 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-center transition-colors"
                  >
                    Create Account
                  </Link>
                </div>
            ...
            {/* Owner Login Card */}
            <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow overflow-hidden border-t-4 border-green-600">
              <div className="p-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">For Owners</h3>
                <p className="text-gray-600 mb-6 text-center">
                ...
                <div className="flex flex-col gap-3">
                  <Link
                    to="/owner/login"
                    className="inline-block px-6 py-2 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 text-center transition-colors"
                  >
                    Owner Login
                  </Link>
                  <Link
                    to="/owner/register"
                    className="inline-block px-6 py-2 border-2 border-green-600 text-base font-medium rounded-md text-green-600 hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 text-center transition-colors"
                  >
                    Register Property
                  </Link>
                </div>
